...
export const stagingBuildings = pgTable("staging_gadhawa_buildings", {
...
export const buildings = pgTable("gadhawa_buildings", {
  id: varchar("id", { length: 48 }).primaryKey(), // Unique identifier for the record
  surveyDate: timestamp("survey_date"),
  enumeratorName: varchar("enumerator_name", { length: 255 }),
...
export const buildingEditRequests = pgTable(
  "gadhawa_building_edit_requests",
  {
...
export const buildingTokens = pgTable("gadhawa_building_tokens", {
