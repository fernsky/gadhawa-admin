...
const gadhawaAgriculturalLand = pgTable("gadhawa_agricultural_land", {
...
export default gadhawaAgriculturalLand;
export const staginggadhawaAgriculturalLand = pgTable(
...
export type gadhawaAgriculturalLand =
  typeof gadhawaAgriculturalLand.$inferSelect;
export type StaginggadhawaAgriculturalLand =
  typeof staginggadhawaAgriculturalLand.$inferSelect;
