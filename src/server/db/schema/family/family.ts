...
export const stagingFamily = pgTable("staging_gadhawa_family", {
...
export const family = pgTable("gadhawa_family", {
  id: text("id").primaryKey().notNull(),
...
export const familyEditRequests = pgTable("gadhawa_family_edit_requests", {
