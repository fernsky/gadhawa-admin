...
export const staginggadhawaAnimalProduct = pgTable(
...
export const gadhawaAnimalProduct = pgTable(
  "gadhawa_animal_product",
  {
    id: varchar("id", { length: 48 }).primaryKey().notNull(),
...
export type gadhawaAnimalProduct =
  typeof gadhawaAnimalProduct.$inferSelect;
export type StaginggadhawaAnimalProduct =
  typeof staginggadhawaAnimalProduct.$inferSelect;
