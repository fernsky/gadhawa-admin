...
export const staginggadhawaIndividual = pgTable(
...
export const gadhawaIndividual = pgTable("gadhawa_individual", {
...
export type gadhawaIndividual = typeof gadhawaIndividual.$inferSelect;
export type StaginggadhawaIndividual =
  typeof staginggadhawaIndividual.$inferSelect;
