...
VALUES 
  ('house_ward_1', 1, 1688, NOW()),
  ('house_ward_2', 2, 1169, NOW()),
  ('house_ward_3', 3, 1135, NOW()),
  ('house_ward_4', 4, 1265, NOW()),
  ('house_ward_5', 5, 1482, NOW()),
  ('house_ward_6', 6, 1714, NOW()),
  ('house_ward_7', 7, 1320, NOW()),
  ('house_ward_8', 8, 191, NOW());
